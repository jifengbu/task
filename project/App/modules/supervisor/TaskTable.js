...
const TaskList = require('../leader/TaskList.js');
const CareTaskList = require('../leader/CareTaskList.js');
const ApproveTaskList = require('../leader/ApproveTaskList.js');
const RepulseTackList = require('../leader/RepulseTackList.js');
...
module.exports = React.createClass({
    ...
    render () {
        ...
        let menuAdminArray = [];
        let taskArr = [{"key": "0","name": "最关心任务",},{"key": "1","name": "审批任务",}];
        if (dataDetail) {
