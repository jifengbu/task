        ...
        return (
            <Modal transparent>
                <TouchableOpacity
                    ...
                    <View style={[styles.background, { height:sr.s(302)}]}>
                        <View style={[styles.container, { height:sr.s(282)}]}>
                            <View style={[styles.textStyleViewNoSide, { height: sr.s(220 - textHeight) }]}>
                                <TextInput
